...
<p>Review is documented as 4 tasks: <strong>Review task list</strong>, <strong>Review assessment summaries</strong>, <strong>Sign-off recommendation</strong>, and <strong>Review conditions</strong>. Determination is documented as <strong>Publish determination</strong>. All four application types use the same Review and Determination stages.</p>
